...
<div class="max-w-xl mx-auto bg-white rounded shadow p-8">
    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="price" id="price" class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-teal" value="{{ old('price') }}" required>
        </div>
        <div class="mb-4">
